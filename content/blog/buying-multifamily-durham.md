---
title: "Buying Multifamily in Durham: A Different County, A Different Tax Cycle"
slug: "buying-multifamily-durham"
description: "Durham County operates on its own reappraisal cycle, separate from Wake. The local pre-offer items that distinguish Durham underwriting from Raleigh, even within the same metro."
date: "2026-03-11"
category: "Market Guide"
market: "Durham"
keywords:
  - "buying multifamily Durham"
  - "Durham apartment building due diligence"
  - "Durham County reappraisal"
  - "Durham multifamily underwriting"
  - "Triangle multifamily Durham"
author: "DealBrief"
---
...
The cycle math is the same as Charlotte and Raleigh: your year-1 tax is the seller's tax (adjusted for any millage changes the county approves), and the reset arrives at the next reappraisal. The combined rate DealBrief uses for property inside the City of Durham is approximately $0.99 per $100 of assessed value (Durham County FY25-26 rate of $0.5542 + City of Durham $0.4371 = $0.9913 / $100, or about 0.99% of assessed value). That is higher than Mecklenburg (about 0.83%) or Raleigh (about 0.87%), mostly because Durham County's own general fund rate ($0.5542) sits above Wake's ($0.5171) and Mecklenburg's ($0.4831). Parcels in the Durham County slice of Chapel Hill run higher still, closer to 1.05% once the town rate layers on.
...
Pull the [Durham County permit history](https://www.dconc.gov) and cross-reference broker renovation claims thoroughly. The city's Permits and Inspections department is also a useful source for code violations. See the [full guide to checking permit history](/blog/check-multifamily-renovation-permits).
...
[Durham County's permit portal](https://www.dconc.gov) covers building permits, inspections, and code enforcement for unincorporated Durham. City of Durham permits have a separate portal. Make sure you're searching the right one based on the parcel's jurisdiction.

## The standard checklist still applies

The Durham-specific items above sit on top of the general [pre-offer due diligence checklist](/blog/pre-offer-due-diligence-checklist-small-multifamily). Permit history, code violations, demographics trajectory, debt service stress test, FEMA flood zone (relevant for parts of New Hope Creek and Eno River-adjacent property) all still matter.
...
[DealBrief](https://www.getdealbrief.com) pulls Durham County assessment, current combined millage, sale history, permit records, FEMA flood zone, demographic trajectory, and the full debt service scenario grid for any Durham-area multifamily address. Your first report is free.
