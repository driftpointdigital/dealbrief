---
title: "Buying Multifamily in Phoenix: The LPV / FCV Split and Other Arizona Quirks"
slug: "buying-multifamily-phoenix"
description: "Arizona's Limited Property Value system caps annual assessment growth at 5%, which makes Phoenix multifamily underwriting fundamentally different from Texas or Florida. Here's how to model it correctly."
date: "2026-04-13"
category: "Market Guide"
market: "Phoenix"
keywords:
  - "buying multifamily Phoenix"
  - "Phoenix apartment building due diligence"
  - "Arizona LPV multifamily"
  - "Maricopa County tax"
  - "Phoenix multifamily underwriting"
author: "DealBrief"
---
...
Phoenix permit history is available through the city's [Planning & Development Department](https://www.phoenix.gov/pdd). Search by parcel through the PDD Online system. Cross-reference broker renovation claims against permit records. See the [full guide to checking permit history](/blog/check-multifamily-renovation-permits).
...
The Phoenix-specific items above sit on top of the general [pre-offer due diligence checklist](/blog/pre-offer-due-diligence-checklist-small-multifamily). FEMA flood zone (relevant for parts of the Salt River corridor), demographics, debt service stress test, permit history all still matter.

Tax modeling for Phoenix is the easy part once you know the LPV system. [Full tax modeling guide](/blog/post-sale-tax-reassessment-multifamily).

## Or get the Phoenix research done for you

[DealBrief](https://www.getdealbrief.com) pulls Maricopa County LPV and FCV, current combined millage, property classification (Class 4 vs Class 1), sale history, permit records, FEMA flood zone, and the full debt service scenario grid for any Phoenix multifamily address. Your first report is free.
