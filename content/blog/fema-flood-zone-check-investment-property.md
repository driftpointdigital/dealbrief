---
title: "How to Run a FEMA Flood Zone Check on an Investment Property"
slug: "fema-flood-zone-check-investment-property"
description: "FEMA flood zone designation drives your insurance cost, your buyer pool at exit, and in some cases whether a lender will even close. Here's how to check, what the zones mean, and what to do with the result."
date: "2026-03-15"
category: "Due Diligence"
keywords:
  - "FEMA flood zone check rental property"
  - "FEMA zone A multifamily"
  - "flood zone check investment property"
  - "flood insurance multifamily"
  - "AE zone real estate"
author: "DealBrief"
---
...
- **Zone V** ("V", "V1-V30", "VE"): coastal high-hazard zone with wave action. Premiums are dramatically higher than AE (often $8,000-$25,000/year for small multifamily). Lenders may also require additional structural certifications.

- **Zone D**: unstudied. Risk is undetermined. Lenders treat this conservatively, usually requiring insurance regardless.
...
Go to [msc.fema.gov](https://msc.fema.gov), enter the address, and pull the FIRMette (a snapshot of the relevant Flood Insurance Rate Map). The FIRMette shows the property's location relative to floodplain boundaries.
...
The [FEMA NFHL Map Viewer](https://hazards-fema.maps.arcgis.com) is the same data in an easier interface. Zoom to the address, see the zone overlay, click the parcel for details.
...
3. **Exit cap adjustment.** Build the +50 to +100 bps cap rate at exit into your IRR projection. The cleaner your assumptions, the less likely you are to be the buyer who learns at exit that the market has repriced flood-zone risk while you weren't watching.

## Or get the flood zone check done for you

[DealBrief](https://www.getdealbrief.com) pulls FEMA flood zone designation for any address in our covered markets, alongside the rest of the [pre-offer due diligence checklist](/blog/pre-offer-due-diligence-checklist-small-multifamily). Your first report is free.
